...
func (t *SubstraChaincode) Invoke(stub shim.ChaincodeStubInterface) peer.Response {
	...
	case "createAggregateTraintuple":
		result, err = createAggregateTraintuple(db, args)
	case "logFailTest":
	...
	case "queryAggregateTraintuple":
		result, err = queryAggregateTraintuple(db, args)
	...
	case "queryAggregateTraintuples":
		result, err = queryAggregateTraintuples(db, args)
